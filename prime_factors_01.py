...
#
n = int(input("Enter your number to test: "))
# Initialize t0.
t0 = time.time()
print(f"Seconds passed since the epoch: {t0}")
...
t1 = time.time()
print(f"Seconds passed since the epoch: {t1}")
print(f"\nSeconds that the is_prime_v2 function took to test {n}: {t1 - t0}")
